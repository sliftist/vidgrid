...
export interface Palette {
    ...
    infoColor?: string;    // color override for GridCell-info text (defaults to muted)
    infoShadow?: string;   // text-shadow on GridCell-info text (neon themes)
...
.GridCell-info { color: ${p.infoColor || p.muted}; ${infoShadow} }
...
export const VAPORWAVE_CSS = buildTheme({
    ...
    infoColor: "hsl(0, 0%, 100%)",
    infoShadow: "1px 1px 0 hsl(263, 67%, 9%), -1px 1px 0 hsl(263, 67%, 9%), 1px -1px 0 hsl(263, 67%, 9%), -1px -1px 0 hsl(263, 67%, 9%)",
