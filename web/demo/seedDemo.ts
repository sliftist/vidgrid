...
export async function seedDemoData(): Promise<void> {
    ...
    const add = (relativePath: string, durationSec: number, watchedPct: number, idx: number) => {
        ...
        fileRecords.push({
            ...
            mediaInfo: {
                format: relativePath.endsWith(".mp4") ? "MP4" : "Matroska",
                trackCount: 2,
                tracks: [
                    {
                        kind: "video",
                        number: 1,
                        codec: relativePath.endsWith(".mp4") ? "avc" : "hevc",
                        codecString: relativePath.endsWith(".mp4") ? "avc1.640029" : "hvc1.1.6.L120.90",
                        codedWidth: 1920, codedHeight: 1080,
                        displayWidth: 1920, displayHeight: 1080,
                        frameRate: 23.976,
                        hdr: !relativePath.endsWith(".mp4"),
                        colorPrimaries: "bt709", colorTransfer: "bt709", colorMatrix: "bt709",
                        colorFullRange: false,
                        bitrate: 8_500_000,
                    },
                    {
                        kind: "audio",
                        number: 2,
                        codec: relativePath.endsWith(".mp4") ? "aac" : "eac3",
                        channels: relativePath.endsWith(".mp4") ? 2 : 6,
                        sampleRate: 48000,
                        bitrate: relativePath.endsWith(".mp4") ? 192_000 : 640_000,
                        language: "eng",
                    },
                ],
            },
